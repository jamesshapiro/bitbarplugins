...
silver_spring = '4369596'
las_vegas = '5506956'
USER_PATH = '/Users/jamesshapiro/code/bitbarplugins/'

location = las_vegas
#location = silver_spring
with open(USER_PATH + 'apikeys.json') as f:
  data = json.load(f)
  api_key = data['open_weather_maps_api']
